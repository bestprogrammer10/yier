...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"智记账","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!***********************************************!*\
  !*** D:/ideaworkspace/yier/uniapp/pages.json ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 30 */
/*!*****************************************************!*\
  !*** D:/ideaworkspace/yier/uniapp/utils/request.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.request = exports.app = exports.Request = void 0;
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var Request = /*#__PURE__*/function () {
  function Request() {
    ...
    (0, _defineProperty2.default)(this, "interceptors", {
      request: function request(config) {
        ...
        // 添加请求ID（用于调试）
        config.header['X-Request-ID'] = _this.generateRequestId();
      ...
      response: function response(_response) {
        ...
        if (_response.statusCode !== 200) {
          return Promise.reject(new Error("HTTP ".concat(_response.statusCode, ": ").concat(_response.errMsg || '请求失败')));
        }
    ...
    this.baseURL = _config.baseURL || BASE_CONFIG.baseURL;
    this.timeout = _config.timeout || BASE_CONFIG.timeout;
    this.header = _objectSpread(_objectSpread({}, BASE_CONFIG.header), _config.header);
  }
  ...
  (0, _createClass2.default)(Request, [{
    ...
    value: function request(options) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var config = {
          ...
          data: options.data || {},
          header: _objectSpread(_objectSpread({}, _this2.header), options.header),
          timeout: options.timeout || _this2.timeout
        };

        // 处理完整URL
        if (!config.url.startsWith('http')) {
          config.url = _this2.baseURL + config.url;
        }

        // 请求拦截器
        try {
          var interceptedConfig = _this2.interceptors.request(config);
        ...
        uni.request({
          ...
          success: function success(res) {
            try {
              var result = _this2.interceptors.response(res);
              resolve(result);
            } catch (error) {
              reject(error);
            }
    ...
    value: function upload(url, filePath) {
      var _this3 = this;
      var name = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'file';
      var formData = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
      return new Promise(function (resolve, reject) {
        var config = _this3.interceptors.request({
        ...
        uni.uploadFile({
          ...
          success: function success(res) {
            try {
              ...
              var result = _this3.interceptors.response({
    ...
    value: function download(url) {
      var _this4 = this;
      return new Promise(function (resolve, reject) {
        var config = _this4.interceptors.request({
          url: _this4.baseURL + url,
        ...
        uni.downloadFile({
          ...
          success: function success(res) {
            if (res.statusCode === 200) {
              ...
              reject(new Error("\u4E0B\u8F7D\u5931\u8D25: ".concat(res.statusCode)));
            }
          },
          fail: reject
        });
...
/* 43 */
/*!***************************************************!*\
  !*** D:/ideaworkspace/yier/uniapp/utils/utils.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.formatNumberAbbreviation = formatNumberAbbreviation;
